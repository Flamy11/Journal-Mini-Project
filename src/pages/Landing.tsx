            ...
            <div className="order-2 lg:order-1">
              ...
              <div className="space-y-3 sm:space-y-4 mb-6 sm:mb-8">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-sm sm:text-base text-gray-700">Detailed trade logging with screenshots</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-primary rounded-full flex-shrink-0"></div>
                  <span className="text-sm sm:text-base text-gray-700">Advanced filtering and search capabilities</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-primary rounded-full flex-shrink-0"></div>
                  <span className="text-sm sm:text-base text-gray-700">Performance analytics and insights</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-primary rounded-full flex-shrink-0"></div>
                  <span className="text-sm sm:text-base text-gray-700">Export data for tax reporting</span>
                </div>
              </div>
              <div>
                <Link to="/signup">
                  ...
                  <div className="p-4 sm:p-6">
                    <div className="space-y-3 sm:space-y-4">
                      <div className="flex justify-between items-center pb-2 border-b">
                        <span className="font-medium text-sm sm:text-base">AAPL</span>
                        <span className="text-green-600 font-medium text-sm sm:text-base">+$342.50</span>
                      </div>
                      <div className="flex justify-between items-center pb-2 border-b">
                        <span className="font-medium text-sm sm:text-base">TSLA</span>
                        <span className="text-red-600 font-medium text-sm sm:text-base">-$125.30</span>
                      </div>
                      <div className="flex justify-between items-center pb-2 border-b">
                        <span className="font-medium text-sm sm:text-base">NVDA</span>
                        <span className="text-green-600 font-medium text-sm sm:text-base">+$892.15</span>
                      </div>
                    </div>
                  </div>
                </div>
